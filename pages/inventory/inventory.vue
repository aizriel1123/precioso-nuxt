        ...
        <Select v-model="selectedType">
          ...
          <SelectContent>
            <SelectGroup>
              ...
              <SelectItem v-for="productType in product_types" :key="productType.type" :value="productType.type">
                {{ productType.type }}
              </SelectItem>
            </SelectGroup>
          </SelectContent>
      ...
      <div class="container-table">
        <div class="table-content">
          <Table>
            ...
            <TableBody>
              <TableRow v-for="product in paginatedProducts" :key="product.id" @click="selectProduct(product)">
            ...
            <PaginationList v-slot="{ items }" class="pagination-list">
              ...
              <template v-for="(item, index) in items">
                <PaginationListItem v-if="item.type === 'page'" :key="index" :value="item.value" as-child>
                  <Button class="pagination-button" :variant="item.value === currentPage ? 'default' : 'outline'"
        ...
        <form id="update_product_panel">
          <FormField v-slot="{ componentField }" name="update_id">
            <FormItem>
              ...
              <FormControl>
                <Input type="number" min="0" placeholder="Product ID" v-bind="componentField"
                  v-model="selectedProductId" disabled />
              </FormControl>
            </FormItem>
          </FormField>
            ...
            <FormItem>
              ...
              <FormControl>
                <Input type="text" placeholder="Enter Product Name" v-bind="componentField"
                  v-model="selectedProductName" disabled />
              </FormControl>
            </FormItem>
          </FormField>
          ...
          <FormField v-slot="{ componentField }" name="update_product_type">
            <FormItem>
              ...
              <FormControl>
                <Input type="text" placeholder="Enter Product Type" v-bind="componentField"
                  v-model="selectedProductType" disabled />
              </FormControl>
            </FormItem>
          </FormField>
            ...
            <FormItem>
              ...
              <FormControl>
                <Input type="number" min="0" placeholder="Enter Selling Price" v-bind="componentField"
                  v-model="selectedSellingPrice" disabled />
              </FormControl>
            </FormItem>
          </FormField>
            ...
            <FormItem>
              ...
              <FormControl>
                <Input type="number" min="0" placeholder="Enter Stock-in Value" v-bind="componentField"
                  v-model="selectedStock" disabled />
              </FormControl>
            </FormItem>
          </FormField>
            ...
            <FormItem>
              ...
              <FormControl>
                <Input type="number" min="0" placeholder="Enter Warning Level" v-bind="componentField"
                  v-model="selectedCritical" disabled />
              </FormControl>
            </FormItem>
          </FormField>
              ...
              <Select v-bind="componentField" v-model="selectedSupplier">
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem v-for="supplier in supplier_names" :key="supplier.supplier_name"
      ...
      <form @submit.prevent="addNewType">
        <FormField v-slot="{ componentField }" name="new_type">
          <FormItem>
            ...
            <FormControl>
              <Input type="text" placeholder="Enter Type" v-bind="componentField" v-model="newProductType" />
            </FormControl>
            <FormMessage />
          </FormItem>
        </FormField>
      ...
      <form @submit.prevent="addNewProduct">
          ...
          <FormItem>
            ...
            <FormControl>
              <Select v-model="NP_ProductType">
                ...
                <SelectContent>
                  <SelectItem v-for="productType in product_types" :key="productType.id" :value="productType.id">
                    {{ productType.type }}
                  </SelectItem>
                  <SelectItem v-if="product_types.length === 0" disabled value="null">
        ...
        <FormField v-slot="{ componentField }" name="new_product_cost">
          <FormItem>
            ...
            <FormControl>
              <Input type="number" min="0" placeholder="Enter Product Cost" v-bind="componentField"
                v-model="NP_ProductCost" required />
            </FormControl>
            <FormMessage />
          </FormItem>
        </FormField>
        ...
        <FormField v-slot="{ componentField }" name="new_selling_price">
          <FormItem>
            ...
            <FormControl>
              <Input type="number" min="0" placeholder="Enter Selling Price" v-bind="componentField"
                v-model="NP_SellingPrice" required />
            </FormControl>
            <FormMessage />
          </FormItem>
        </FormField>
        ...
        <FormField v-slot="{ componentField }" name="warning_level">
          <FormItem>
            ...
            <FormControl>
              <Input type="number" min="0" placeholder="Enter Warning Level" v-bind="componentField"
                v-model="NP_WarningLevel" required />
            </FormControl>
            <FormMessage />
          </FormItem>
        </FormField>
...
const selectedSellingPrice = ref('');
...
//inputs (new type popup)
const newProductType = ref('')
//inputs (new supplier popup)
const NS_SupplierName = ref('')
const NS_SupplierAddress = ref('')
const NS_ContactNumber = ref('')
//inputs (new product popup)
const NP_ProductName = ref('')
const NP_ProductType = ref('')
const NP_ProductCost = ref('')
const NP_SellingPrice = ref('')
const NP_SupplierName = ref('')
const NP_Stock = ref('')
const NP_WarningLevel = ref('')
const NP_CommissionRate = ref('')
//For pop ups
...
const validateForm = () => {
  if (isEditModalOpen.value === true) {
    return (
      selectedProductName.value.trim() !== '' &&
      selectedProductType.value.trim() !== '' &&
      (selectedCost.value !== '' && !isNaN(selectedCost.value)) &&
  ...
  } else if (isSupplierModalOpen.value === true) {
    return (
      NS_SupplierName.value.trim() !== '' &&
      NS_SupplierAddress.value.trim() !== '' &&
...
const editExistingProduct = form.handleSubmit(async (values) => {
  ...
  if (values.edited_product_cost >  values.edited_selling_price) {
    ...
    update_selling_price: values.edited_selling_price || selectedSellingPrice.value,
...
const selectProduct = (product) => {
  ...
  selectedSellingPrice.value = product.sellingPrice;
